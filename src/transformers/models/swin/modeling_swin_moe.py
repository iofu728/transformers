...
class SwinLayer(nn.Module):
    def __init__(self, config, dim, input_resolution, num_heads, shift_size=0, is_moe=False):
        super().__init__()
...
class SwinStage(nn.Module):
    def __init__(self, config, dim, input_resolution, depth, num_heads, drop_path, downsample, moe_block=[-1]):
        super().__init__()
        self.config = config
        self.dim = dim
